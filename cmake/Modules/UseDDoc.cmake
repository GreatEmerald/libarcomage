...
if (NOT CMAKE_D_BUILD_DOCS)
	...
	if (NOT CMAKE_D_DDOC_FILES)
		set(CMAKE_D_DDOC_FILES "${CMAKE_CURRENT_BINARY_DIR}/documentation/candydoc/candy.ddoc;${CMAKE_CURRENT_BINARY_DIR}/documentation/candydoc/modules.ddoc" CACHE STRING FALSE FORCE)
	...
	if (NOT CMAKE_D_DDOC_MODULES)
		...
		endforeach(item)
	endif (NOT CMAKE_D_DDOC_MODULES)
	
	# create formatted modules string
	set(modString "MODULES = \n")
	foreach(item ${CMAKE_D_DDOC_MODULES})
